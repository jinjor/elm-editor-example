...
var author$project$Main$Model = F2(
	function (value, lastSaved) {
		return {lastSaved: lastSaved, value: value};
	});
...
var author$project$Main$save = _Platform_incomingPort('save', elm$json$Json$Decode$string);
var author$project$Main$subscriptions = function (_n0) {
	return author$project$Main$save(author$project$Main$Save);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Hello, press `Ctrl+S` to see the result.')
							]))
					])),
				A2(
				elm$html$Html$pre,
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.lastSaved)
					]))
			]));
};
